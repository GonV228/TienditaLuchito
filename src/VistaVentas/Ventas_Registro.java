 ...
 * @author SARA
 */
public class Ventas_Registro extends javax.swing.JFrame {

    /** Creates new form InterfazAdministrador */
    public Ventas_Registro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventas_Registro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventas_Registro().setVisible(true);
            }
        });
    }
